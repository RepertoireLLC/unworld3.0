        ...
        <div className="flex flex-col border-r border-white/10 bg-white/5 p-6">
          ...
          <div className="mt-6 space-y-4">
            ...
            <div className="rounded-2xl border border-white/10 bg-white/10 p-4 text-sm text-white/80">
              <p className="font-medium text-white">Meet Scribe</p>
              <p className="mt-2 text-xs text-white/60">
                Scribe is Harmonia&apos;s native conversational guide. Link your OpenAI key to awaken Scribe or onboard additional
                models alongside it.
              </p>
            </div>
            ...
            >
              <div className="space-y-2">
                ...
                <input
                  ...
                  placeholder="Scribe (ChatGPT), Gemini, Grok v1, Local-Llama3"
